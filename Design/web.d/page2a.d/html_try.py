...
# tab and header
hd = {"loc": "Input Suggestions from other source"}
hdr = dict(page="Input Suggestions from other source", today="Wednesday  March 06, 2019")
...
template=env.get_template("page2a.jhtml")
