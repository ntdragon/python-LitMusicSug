...
hd = {"loc": "Main"}
hdr = dict(page="Main", today="Saturday  March 02, 2019")
...
input_ = {"hd":hd, "hdr":hdr, "cevt":cevt, "dayt":dayt,"parts":parts, "tdy":tdy, "cal":cal, "pref":pref, "dts":dts, "days":days, "colorsm":colorsm  }
